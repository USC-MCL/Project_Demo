...
class Saab():
    def __init__(self, num_kernels=-1, useDC=True, needBias=True, isInteger=False, bits=8, opType='int64', energyTH=-1):
        self.par = None
        self.Kernels = []
        self.Bias = []
        self.Mean0 = []
        ...
        self.useDC = useDC#will clean up all needBias in later version
...
if __name__ == "__main__":
    ...
    saab = Saab(num_kernels=32, useDC=True, needBias=False)
